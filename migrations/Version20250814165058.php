...
final class Version20250814165058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , entity_type VARCHAR(50) NOT NULL, entity_id VARCHAR(36) NOT NULL, comment CLOB NOT NULL, "action" VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_5048D0E5642B8210 FOREIGN KEY (admin_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
