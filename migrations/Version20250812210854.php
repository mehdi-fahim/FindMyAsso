...
final class Version20250812210854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , message CLOB NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , admin_notes CLOB DEFAULT NULL, reviewed_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , responded_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        , name VARCHAR(255) NOT NULL, siret VARCHAR(14) DEFAULT NULL, email_public VARCHAR(180) NOT NULL, phone_public VARCHAR(20) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, description CLOB NOT NULL, species_supported CLOB NOT NULL --(DC2Type:json)
        , region VARCHAR(100) NOT NULL, department VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, postal_code VARCHAR(10) NOT NULL, street VARCHAR(255) NOT NULL, lat NUMERIC(10, 8) DEFAULT NULL, lng NUMERIC(11, 8) DEFAULT NULL, is_approved BOOLEAN NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        , amount INTEGER NOT NULL, currency VARCHAR(3) NOT NULL, stripe_checkout_id VARCHAR(255) DEFAULT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , message CLOB DEFAULT NULL, stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_31E581A0A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_31E581A0EFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , user_id CHAR(36) NOT NULL --(DC2Type:uuid)
        , association_id CHAR(36) DEFAULT NULL --(DC2Type:uuid)
        , type VARCHAR(20) NOT NULL, description CLOB NOT NULL, quantity VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , notes CLOB DEFAULT NULL, region VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_A91010CFA76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A91010CFEFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , reason CLOB NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , status VARCHAR(20) NOT NULL, admin_notes CLOB DEFAULT NULL, reviewed_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        , association_id CHAR(36) NOT NULL --(DC2Type:uuid)
        , species VARCHAR(20) NOT NULL, capacity_total INTEGER NOT NULL, capacity_available INTEGER NOT NULL, notes CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_82C772D5EFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , password VARCHAR(255) NOT NULL, is_verified BOOLEAN NOT NULL, full_name VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON "user" (email)');
        $this->addSql('CREATE TABLE vet_profile (id CHAR(36) NOT NULL --(DC2Type:uuid)
        , user_id CHAR(36) NOT NULL --(DC2Type:uuid)
        , clinic_name VARCHAR(255) NOT NULL, rpps_or_license VARCHAR(255) NOT NULL, services CLOB NOT NULL --(DC2Type:json)
        , free_care_slots INTEGER NOT NULL, region VARCHAR(100) NOT NULL, department VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, postal_code VARCHAR(10) NOT NULL, street VARCHAR(255) NOT NULL, lat NUMERIC(10, 8) DEFAULT NULL, lng NUMERIC(11, 8) DEFAULT NULL, is_approved BOOLEAN NOT NULL, notes CLOB DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        , association_id CHAR(36) NOT NULL --(DC2Type:uuid)
        , label VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, quantity_needed VARCHAR(255) NOT NULL, urgency VARCHAR(20) NOT NULL, is_active BOOLEAN NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , notes CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_6424F4E8EFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
